...
→ Laadpaal krijgt rest wanneer warmtepomp niet volledig draait<br>
...
$two_col_rechts    = '<ul class="checklist">
  ...
  <li class="checklist__item"><span class="checklist__vink">✓</span><span>Stroom in oprit of garage</span></li>
