...
$kaarten_variant = 'wit';
$kaarten_label   = 'Kies jouw woningtype';
$kaarten_titel   = 'Energielabel voor elke woning';
$kaarten_intro   = 'De opnametijd en prijs hangen af van het type en de oppervlakte van jouw woning.';
$kaarten_cols    = 3;
$kaarten_id      = 'prijzen';
$kaarten_items   = [
  [
...
$kaarten_items   = [
  ...
  [
    ...
    'tekst'     => 'Vergelijk energiecontracten en vind het beste aanbod voor jouw situatie. Onafhankelijk en overzichtelijk.',
...
$kaarten_items   = [
  [
    ...
    'icoon' => '<svg viewBox="0 0 24 24" fill="none" stroke="#1a5c32" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9.5L12 3l9 6.5V20a1 1 0 01-1 1H4a1 1 0 01-1-1V9.5z"/><path d="M9 21V12h6v9"/></svg>',
    'tekst' => 'Je verkoopt je huis, wilt je hypotheek oversluiten of bent benieuwd hoe energiezuinig je woning is.',
    'extra' => '
