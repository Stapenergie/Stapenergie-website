...
$hero_usps     = [
  'Onafhankelijk advies — aan je kant van de tafel',
...
$kaarten_items   = [
  [
    ...
    'tekst'      => 'Je factuur vertelt wat je betaalt. Wij weten of je contract ook klopt. STAP Energie analyseert je huidige contract en adviseert over contractvorm, looptijd en timing.',
    'uitgelicht' => true,
  ...
  [
    ...
    'tekst'     => 'Welke maatregelen leveren het meeste op voor je situatie? STAP Energie brengt de meest rendabele verbeteringen in kaart en begeleidt de uitvoering, inclusief beschikbare subsidies.',
...
$two_col_links     = '
  ...
  <p style="color:var(--subtekst);line-height:1.7;margin-bottom:14px;">Energieprijzen bewegen voortdurend. Gasopslagstanden, seizoenen, geopolitieke ontwikkelingen — ze bepalen mede wat je betaalt. Wie die dynamiek begrijpt, kan beter inschatten wanneer het slim is om vast te leggen en voor hoe lang.</p>
...
$two_col_rechts    = '
  <div style="display:flex;flex-direction:column;gap:20px;">
    <div class="icon-tekst">
      ...
      <div class="icon-tekst__content"><div class="icon-tekst__titel">Contractanalyse als startpunt</div><div class="icon-tekst__tekst">Wij doorlichten je bestaande contract op prijs, voorwaarden en risico. Je krijgt een helder beeld van wat beter kan.</div></div>
    </div>
    <div class="icon-tekst">
    ...
    <div class="icon-tekst">
      ...
      <div class="icon-tekst__content"><div class="icon-tekst__titel">Altijd aan je kant van de tafel</div><div class="icon-tekst__tekst">STAP Energie heeft geen merkvoorkeur. Wij kiezen de partij die het beste bij je situatie past, niet de partij die ons het meeste oplevert.</div></div>
    </div>
  </div>';
...
$kaarten_intro   = 'Met 15+ jaar ervaring aan de leverancierszijde weet STAP Energie precies hoe de energiemarkt werkt — en wat dat betekent voor je contract.';
$kaarten_cols    = 3;
$kaarten_items   = [
  [
