...
$cta_titel     = 'Weten wat STAP voor jouw bedrijf kan betekenen?';
...
$faq_items = [
  ['vraag' => 'Wanneer is het slim om mijn energiecontract te laten doorlichten?',
   'antwoord' => 'Eigenlijk altijd een goed moment, maar zeker als je contract binnen 12 maanden afloopt, als je net een pand hebt gekocht of gehuurd, of als je energierekening de afgelopen tijd opvallend gestegen is. Een contractanalyse kost je niets en levert bijna altijd bruikbare inzichten op.'],
  ['vraag' => 'Mijn bedrijfspand heeft een energielabel, moet ik daar iets mee?',
   'antwoord' => 'Dat hangt af van de klasse. Voor kantoren groter dan 100 m² is minimaal label C wettelijk verplicht. Heb je een winkel, opslagruimte of productieruimte? Dan geldt de C-plicht niet automatisch, maar bij verkoop of verhuur is een geldig label wel verplicht. Heb je twijfels over je huidige situatie? STAP Energie kijkt het voor je na.'],
  ['vraag' => 'Wat levert verduurzaming een mkb-bedrijf financieel op?',
   'antwoord' => 'Meer dan de meeste ondernemers verwachten. Betere isolatie verlaagt je stookkosten structureel. LED-verlichting verdient zich doorgaans terug binnen een paar jaar. Zonnepanelen verlagen je inkoopbehoefte. En met regelingen als de ISDE en de EIA wordt de terugverdientijd aanzienlijk korter. STAP Energie brengt de meest rendabele maatregelen voor je situatie in kaart.'],
  ...
  ['vraag' => 'Werkt STAP Energie ook samen met leveranciers?',
   'antwoord' => 'Ja, maar op onze voorwaarden. STAP Energie werkt samen met zorgvuldig geselecteerde leveranciers en installatiepartners die wij beoordelen op kwaliteit en betrouwbaarheid. We kiezen altijd de partij die het beste bij je situatie past.'],
...
$hero_titel    = 'Energie is jouw grootste variabele kostenpost. <em>Het hoeft niet zoveel te kosten.</em>';
...
// ── Drie diensten
$kaarten_variant = 'wit';
$kaarten_label   = 'Wat STAP Energie voor je doet';
$kaarten_titel   = 'Drie diensten, één aanspreekpunt';
$kaarten_intro   = 'Energie-inkoop, energielabels en verduurzaming, STAP Energie overziet het complete energievraagstuk voor je bedrijf.';
$kaarten_cols    = 3;
$kaarten_id      = 'diensten';
$kaarten_items   = [
  [
    ...
    'foto_alt'   => 'Energie-inkoopadvies voor MKB',
    'tekst'      => 'Je factuur vertelt wat je betaalt. Wij weten of jouw contract ook klopt. STAP Energie analyseert je huidige contract en adviseert over contractvorm, looptijd en timing.',
    'uitgelicht' => true,
  ...
  [
    ...
    'foto_alt'  => 'Energielabels voor bedrijfspanden',
    'tekst'     => 'Verplicht bij verkoop, verhuur en oplevering van je bedrijfspand. STAP Energie verzorgt officiële energielabels voor kantoren, winkels, opslagruimtes en andere utiliteitsgebouwen.',
  ...
  [
    ...
    'foto_alt'  => 'Verduurzaming en subsidies voor MKB',
    'tekst'     => 'Welke maatregelen leveren het meeste op voor jouw situatie? STAP Energie brengt de meest rendabele verbeteringen in kaart en begeleidt de uitvoering, inclusief beschikbare subsidies.',
...
$two_col_links     = '
  ...
  <p style="color:var(--subtekst);line-height:1.7;margin-bottom:14px;">Energieprijzen bewegen voortdurend. Gasopslagstanden, seizoenen, geopolitieke ontwikkelingen: ze bepalen mede wat je betaalt. Wie die dynamiek begrijpt, kan beter inschatten wanneer het slim is om vast te leggen, voor hoe lang, of juist wanneer een dynamisch contract verstandiger is.</p>
...
$two_col_rechts    = '
  <div style="display:flex;flex-direction:column;gap:20px;">
    <div class="icon-tekst">
      ...
      <div class="icon-tekst__content"><div class="icon-tekst__titel">Contractanalyse als startpunt</div><div class="icon-tekst__tekst">Wij lichten je bestaande contract door op prijs, voorwaarden en risico. Je krijgt een helder beeld van wat beter kan.</div></div>
    </div>
    <div class="icon-tekst">
    ...
    <div class="icon-tekst">
      ...
      <div class="icon-tekst__content"><div class="icon-tekst__titel">Altijd aan jouw kant van de tafel</div><div class="icon-tekst__tekst">STAP Energie heeft geen merkvoorkeur. Wij kiezen de partij die het beste bij jouw situatie past, niet de partij die ons het meeste oplevert.</div></div>
    </div>
  </div>';
...
$two_col_variant   = 'wit';
$two_col_label     = 'Energielabel voor je bedrijfspand';
...
$stappen_cols    = 4;
$stappen         = [
  ['nummer' => 1, 'titel' => 'Kennismakingsgesprek', 'tekst' => 'We beginnen met een kort gesprek om je situatie te begrijpen. Wat zijn je grootste energiekosten en wat zijn je doelstellingen?'],
  ['nummer' => 2, 'titel' => 'Analyse & nulmeting',  'tekst' => 'Op basis van je verbruiksdata en contracten stellen wij een helder beeld op van je huidige situatie. Dat is de basis voor goed advies.'],
  ['nummer' => 3, 'titel' => 'Concreet advies',      'tekst' => 'Je ontvangt een onderbouwd advies over inkoop, label of verduurzaming, afgestemd op je situatie, niet een standaard verhaal.'],
  ['nummer' => 4, 'titel' => 'Begeleiding',          'tekst' => 'STAP Energie begeleidt de uitvoering en blijft beschikbaar voor vragen. Energieprijzen veranderen, je strategie blijft actueel.'],
];
...
$kaarten_intro   = 'Met 15+ jaar ervaring aan de leverancierszijde weet STAP Energie precies hoe de energiemarkt werkt. En wat dat betekent voor jouw contract.';
$kaarten_cols    = 3;
$kaarten_items   = [
  [
  ...
  [
    ...
    'tekst' => 'STAP Energie heeft geen exclusieve samenwerkingen die het advies kleuren. Wij selecteren op kwaliteit en kiezen de partij die het beste bij je situatie past.',
  ],
  [
    ...
    'tekst' => 'Of het nu gaat om inkoop, een energielabel of verduurzaming, je hebt altijd één vast aanspreekpunt die je situatie kent en het complete energievraagstuk overziet.',
  ],
];
include $root . 'includes/components/section-kaarten.php';
